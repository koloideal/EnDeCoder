...
from shift_encryption.choose_input_method.config_input import helper_encode_config_input, helper_decode_config_input


def help_encode_shift(file_content: list = None, file_locate: str = None, data: dict = None) -> str or None:
...
def help_decode_shift(file_content: list = None, file_locate: str = None, data: dict = None) -> str or None:
