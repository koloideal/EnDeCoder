...
from full_viginer_encryption.choose_input_method.config_input import helper_encode_config_input, helper_decode_config_input


def help_encode_full_viginer(file_content: list = None, file_locate: str = None, data: dict = None) -> str or None:
...
def help_decode_full_viginer(file_content: list = None, file_locate: str = None, data: dict = None) -> str or None:
