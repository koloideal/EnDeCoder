from viginer_encryption.choose_input_method.file_input import (
    helper_encode_file_input,
    helper_decode_file_input,
)
from viginer_encryption.choose_input_method.manual_input import (
    helper_encode_manual_input,
    helper_decode_manual_input,
)
from viginer_encryption.choose_input_method.config_input import (
...
def help_encode_viginer(
    file_content: list = None, file_name: str = None, data: dict = None
) -> str or None:
