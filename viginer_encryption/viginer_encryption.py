...
def encode_viginer_encryption(
    string: str, key_word: str, save_register: bool = False
) -> str:
    ...
    try:
        ...
        result: str = get_chr_encode(
            first_step_list, key_word_list, save_register, string
        )
