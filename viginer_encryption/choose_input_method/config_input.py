...
def helper_encode_config_input(data: dict) -> None:
    match data["where_get_data"]:
        case "file":
            while True:
                ...
                if os.path.isfile(f"content/{file_name}.txt"):
                    ...
                    encoded_string: str = encode_viginer_encryption(
                        "".join(content), data["key_word"], data["save_register"]
                    )
        ...
        case "manual":
            ...
            print(
                encode_viginer_encryption(
                    string, data["key_word"], data["save_register"]
                )
            )
        ...
        case "file":
            while True:
                ...
                if os.path.isfile(f"content/{file_name}.txt"):
                    ...
                    encoded_string: str = decode_viginer_encryption(
                        "".join(content), data["key_word"], data["save_register"]
                    )
