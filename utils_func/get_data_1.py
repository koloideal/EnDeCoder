...
def get_data_1():
    ...
    match encoding_or_decoding:
        ...
        case '1':
            ...
            helper.second_dict_with_name_func[int(encryption_method)][0](content, file_name)

        case '2':

            helper.second_dict_with_name_func[int(encryption_method)][1](content, file_name)
