...
from full_shift_encryption.helper_full_shift import (
    help_encode_full_shift,
    help_decode_full_shift,
)
from shift_encryption.helper_shift import help_encode_shift, help_decode_shift
from full_viginer_encryption.helper_full_viginer import (
    help_encode_full_viginer,
    help_decode_full_viginer,
)
...
def get_data_config() -> None:
    ...
    while True:
        try:
            action: str = input(
                "Enter(0, to add config, -0 to delete config or config id): "
            )
